/**
 * workerCleanOutlier Prompt - English Version
 */

import { UserPrompt } from '@/types/prompt';

export const workerCleanOutlierPrompt: UserPrompt = {
    id: 'worker_clean_outlier-v1',
    name: 'worker_clean_outlier',
    title: 'Clean Outliers',
    description: 'Detect and handle outliers using IQR or Z-score method',
    
    slug: 'worker_clean_outlier-v1',
    packageId: 'basic',
