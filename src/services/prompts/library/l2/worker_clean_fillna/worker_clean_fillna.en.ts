/**
 * workerCleanFillna Prompt - English Version
 */

import { UserPrompt } from '@/types/prompt';

export const workerCleanFillnaPrompt: UserPrompt = {
    id: 'worker_clean_fillna-v1',
    name: 'worker_clean_fillna',
    title: 'Fill Missing Values',
    description: 'Fill missing values using mean, median, mode, or custom value',

    slug: 'worker_clean_fillna-v1',
    packageId: 'basic',
    requiredPackages: [],
    outputCharts: ['chart'],
    layer: 'L2_EXECUTION',
