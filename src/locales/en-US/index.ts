...
export const enUS: LanguageConfig = {
    ...
    translations: {
        ...
        hardware: {
            ...
            reasonGood: 'Excellent hardware specs, good local AI performance',
            reasonMedium: 'Moderate hardware specs, Cloud AI recommended for better experience',
            reasonLow: 'Lower hardware specs, Cloud AI strongly recommended',
        },
        header: {
