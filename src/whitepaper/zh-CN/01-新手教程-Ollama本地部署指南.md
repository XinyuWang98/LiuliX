...
> [!IMPORTANT]
> **适用范围提示**：
> 本地模型 (Ollama) 连接功能目前仅支持 **LiuliX Desktop (桌面版)** 或 **本地开发环境**。
> **Web 在线版** 因浏览器安全策略限制，暂无法直接连接本地 Ollama 服务。
...
1. 启动 **LiuliX Desktop** (桌面版)，进入 **Settings** (设置)。
